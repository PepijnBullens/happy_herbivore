...
(3,'2025_02_06_080000_create_categories_table',1),
(4,'2025_02_06_094513_create_products_table',1),
...
CREATE TABLE `order_contents` (
  ...
  `with_dip` bigint(20) unsigned DEFAULT NULL,
  ...
  KEY `order_contents_with_dip_foreign` (`with_dip`),
  CONSTRAINT `order_contents_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_contents_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_contents_with_dip_foreign` FOREIGN KEY (`with_dip`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-10  9:41:21
